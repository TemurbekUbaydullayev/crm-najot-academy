using CRMNAJOTACADEMY.Pages.Students;
using System;
...
namespace CRMNAJOTACADEMY.Pages
{
    public class StudentsPage
    {
        public static async Task RunAsync()
        {
            ...
            Console.WriteLine($"(1) Yangi o'quvchi qo'shish");
            Console.WriteLine($"(2) Barcha o'quvchilar ma'lumotlarini ko'rish");
            Console.WriteLine($"(3) Biror o'quvchi ma'lumotlarini ko'rish");
            Console.WriteLine($"(4) Biror o'quvchi ma'lumotlarini yangilash");
            Console.WriteLine($"(5) Biror o'quvchini o'chirish");
            Console.Write($">>> ");
